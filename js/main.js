...
function editUpdate(){
  ...
  editArray.forEach(function(element){ //Para cada botão de edit, ...
    ...
    function addEdit(){
      ...
      document.querySelector(".send").addEventListener("click", sendEdit) //... espera o botão send ser clicado, ...
      function sendEdit(){
        document.querySelector(".send").removeEventListener("click", sendEdit);
